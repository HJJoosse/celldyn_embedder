...
cut_offs = {
    "c_b_wbc": {"min": 0, "max": 50},
    "c_b_neu": {"min": 0, "max": 50},
    "c_b_seg": {"min": 0, "max": 50},
    "c_b_wvf": {"min": 0.75, "max": 1.0},
    "c_b_rtcfmn": {"min": 100, "max": 175},
    "c_b_rtcfcv": {"min": 0, "max": 25},
    "c_b_retc": {"min": 0, "max": 300},
    "c_b_rdw": {"min": 0, "max": 30},
    ...
    "c_b_pretc": {"min": 0, "max": 10},
    "c_b_ppmn": {"min": 100, "max": 150},
    "c_b_ppcv": {"min": 10, "max": 30},
    "c_b_pmone": {"min": 0, "max": 30},
    "c_b_pmon": {"min": 0, "max": 30},
    "c_b_pmic": {"min": 0, "max": 10},
    "c_b_pmac": {"min": 0, "max": 25},
    "c_b_plto": {"min": 0, "max": 1000},
    "c_b_plti": {"min": 0, "max": 1000},
    "c_b_pimn": {"min": 120, "max": 175},
    "c_b_picv": {"min": 10, "max": 25},
    "c_b_phpr": {"min": 0, "max": 2},
    "c_b_phpo": {"min": 0, "max": 100},
    "c_b_peos": {"min": 0, "max": 100},

...
def random_search(X, embedder, evaluators:dict, param_grid:dict ,ascending:list,file_name:str,subsampling:int,standardised:bool = False, max_evals:int = 300, num_iter:int = 5, random_state = None, **kwargs):
    """
...
def grid_search(X, embedder, evaluators:dict, param_grid:dict ,ascending:list,file_name:str,subsampling:int,standardised:bool = False,num_iter:int = 5, random_state = None, **kwargs):
    """
